...
#+BEGIN_SRC fish
  ...
  bashtop bat biber bitwarden-bin bluez-firmware bluez-utils bzip2 chicken \
  chromium clisp corrupter-git cppcheck cppreference cppreference-devhelp \
  cpupower discord-canary discount docker docker-compose \
