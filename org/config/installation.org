...
#+BEGIN_SRC fish
  ...
  noto-fonts-emoji npm ntfs-3g numlockx obs-studio openssh otf-fandol otf-ipafont \
  p7zip pacman-contrib pandoc-bin pass pavucontrol pdfpc picom-ibhagwan-git \
  ...
  ripgrep rofi rsync rtv ruby-rb-fsevent ruby-sass rustup samba scrot sent shadow \
  siji-git simplescreenrecorder sshfs st-luke-git sxiv texlive-bin \
  texlive-langchinese texlive-langcyrillic texlive-langgreek texlive-langjapanese \
  texlive-langkorean texlive-latexextra texlive-localmanager-git texlive-most \
  tmux tree ttf-arphic-uming ttf-baekmuk ttf-charis-sil ttf-dejavu \
