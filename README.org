...
** Install our needed packages
   ...
   #+BEGIN_SRC sh :dir /sudo:: :exports code
     yay -S --needed asar ascii aspell-en aspell-fr assimp autoconf automake \
         ...
         texlive-langkorean texlive-latexextra texlive-localmanager-git \
         texlive-music texlive-pictures texlive-pstricks texlive-publishers \
         texlive-science tmux tree  ttf-arphic-uming ttf-baekmuk \
         ...
         xorg-server xorg-xinit xss-lock yadm graphviz xorg-xprop
   #+END_SRC
